...
offer_2 += [
    ...
    p('<b>Доступ к программе.</b> Право использования системы «логистРу» предоставляется на условиях простой (неисключительной) лицензии. Условия приобретения лицензии и использования системы изложены в публичной оферте.', 'legal'),
...
from create_functional_characteristics import build_functional
