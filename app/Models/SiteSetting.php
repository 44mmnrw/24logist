...
class SiteSetting extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'community_about_card_enabled' => 'boolean',
            ...
            'community_ai_timeweb_token' => 'encrypted',
            'community_ai_collector_token' => 'encrypted',
            'route_calculator_enabled' => 'boolean',
            'route_api_base_url' => 'encrypted',
            'route_api_secret' => 'encrypted',
            'route_api_timeout' => 'integer',
            'cabinet_login_enabled' => 'boolean',
            'cabinet_registration_enabled' => 'boolean',
            'cabinet_login_url' => 'encrypted',
            'cabinet_login_forgot_url' => 'encrypted',
            'cabinet_login_connect_ip' => 'encrypted',
            'cabinet_login_api_secret' => 'encrypted',
            'cabinet_login_api_timeout' => 'integer',
    ...
    public static function instance(): self
    {
        return static::query()->firstOrCreate(
            ...
            [
                ...
                'community_about_card_eyebrow' => 'логистРу',
                'community_about_card_title' => 'Сообщество о логистике',
                'community_about_card_description' => 'Практические вопросы перевозчиков, экспедиторов, грузовладельцев и логистов.',
                'community_about_card_members_label' => 'участников',
                'community_about_card_topics_label' => 'обсуждений',
                'community_about_card_button_text' => 'Все обсуждения',
                'cabinet_login_enabled' => false,
                'cabinet_login_button_text' => 'Войти в личный кабинет',
                'cabinet_login_button_style' => 'ghost',
                ...
                'cabinet_login_forgot_text' => 'Забыли пароль?',
                'cabinet_login_api_timeout' => 15,
