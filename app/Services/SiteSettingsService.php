...
{
    private const CACHE_KEY = 'site.settings.v25';
    ...
    public function communityAiCollectorToken(): string
    {
        return trim((string) $this->get()->getAttribute('community_ai_collector_token'));
    }
