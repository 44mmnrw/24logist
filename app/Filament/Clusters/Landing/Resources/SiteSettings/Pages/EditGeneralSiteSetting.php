...
class EditGeneralSiteSetting extends EditRecord
{
    ...
    protected function mutateFormDataBeforeFill(array $data): array
    {
        ...
        foreach (['community_telegram_client_secret', 'community_telegram_bot_token', 'community_vk_client_secret', 'community_vk_service_token', 'community_max_bot_token', 'community_max_webhook_secret', 'community_ai_timeweb_token', 'route_api_secret', 'cabinet_login_api_secret'] as $field) {
            $data[$field] = '';
        }
