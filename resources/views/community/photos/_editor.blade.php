...
<div @class(['community-photo-editor', 'community-photo-editor--compact' => $compact])>
    ...
    @endif
    @if ($compact)
        <input class="community-composer-sr-only" type="file" name="photos[]" accept="image/jpeg,image/png,image/webp" multiple aria-label="Выбрать фото для комментария" data-community-photo-input data-max-photos="{{ \App\Services\Community\CommunityPhotoService::MAX_COUNT }}" data-max-bytes="{{ \App\Services\Community\CommunityPhotoService::MAX_FILE_KB * 1024 }}">
    @else
