...
<div class="landing-shell community-auth-shell">
    <div class="community-auth-card" data-max-auth
        ...
        <p>Отсканируйте QR-код телефоном или откройте MAX на этом устройстве. Ссылка действует 5 минут.</p>
        <img class="community-qr" src="{{ $qr }}" alt="QR-код для входа через MAX" width="260" height="260">
        <a class="community-provider community-provider--max" href="{{ $deepLink }}">Открыть в MAX</a>
