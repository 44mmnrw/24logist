...
<div class="landing-shell community-auth-shell">
    <div class="community-auth-card" data-max-auth
        ...
        <p>Отсканируйте QR-код или откройте MAX на этом устройстве. В MAX нажмите «Авторизоваться», затем вернитесь в сообщество. Ссылка действует 5 минут.</p>
        ...
        <p data-max-status class="community-auth-status">Ожидаем подтверждение в MAX…</p>
    </div>
</div>
