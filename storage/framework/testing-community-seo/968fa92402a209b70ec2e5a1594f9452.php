...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->epd_popup_enabled || $settings->epd_popup_registration_enabled): ?>
<div
    class="epd-popup"
    data-epd-popup
    data-popup-variant="<?php echo e($popupVariant); ?>"
    data-popup-version="<?php echo e($registrationVariant ? $registrationPopupVersion : 1); ?>"
    <?php if (! ($registrationVariant)): ?>
        data-submit-url="<?php echo e(route('leads.epd-presentation.store')); ?>"
    <?php endif; ?>
    data-show-delay="<?php echo e($registrationVariant ? 30 : 4); ?>"
    data-cooldown-days="3"
    role="dialog"
    aria-modal="<?php echo e($registrationVariant ? 'false' : 'true'); ?>"
    <?php if($registrationVariant): ?>
...
>
    ...
    <div class="epd-popup__card<?php echo e($registrationVariant ? ' epd-popup__card--registration' : ''); ?>" role="document">
        ...
        <div class="epd-popup__visual">
            <div class="epd-popup__visual-frame">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($registrationVariant): ?>
                    <a
                        class="epd-popup__registration-image-link"
                        href="<?php echo e($settings->epd_popup_registration_button_url ?: 'https://logistsystem.ru/register'); ?>"
                        target="_blank"
                        rel="noopener noreferrer"
                        data-epd-registration-cta
                        aria-label="<?php echo e($settings->epd_popup_registration_button_text ?: 'Создать личный кабинет'); ?>"
                    >
                        <img
                            src="<?php echo e($registrationImage); ?>"
                            alt="<?php echo e($settings->epd_popup_registration_image_alt ?: 'Специальное предложение ЛогистРу'); ?>"
                            width="1254"
                            height="1254"
                            loading="lazy"
                            decoding="async"
                ...
                <?php else: ?>
                    <img
                        src="<?php echo e(asset('images/epd-announcement-27-08.png')); ?>"
        ...
        <div class="epd-popup__content">
            <div class="epd-popup__form-state" data-epd-form-state>
                ...
                <form class="epd-popup__form" data-epd-form novalidate>
                    ...
                    <small class="epd-popup__consent">Нажимая кнопку, вы соглашаетесь с <a href="<?php echo e(route('legal.privacy_policy')); ?>">политикой конфиденциальности</a>.</small>
                </form>
            </div>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\laragon\www\24logistru\resources\views/components/site/epd-presentation-popup.blade.php ENDPATH**/ ?>