...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.seo.open-graph','data' => ['blogIndex' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['blog-index' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.seo.structured-data','data' => ['blogIndex' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        <main>
            <section class="blog-hero">
                <div class="landing-shell blog-hero__shell">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blogKicker !== ''): ?>
                        <div class="section-kicker"><?php echo e($blogKicker); ?></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <h1><?php echo e($blogTitle); ?></h1>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blogDescription !== ''): ?>
                        <p><?php echo e($blogDescription); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </section>

            <?php echo $__env->make('blog._categories', ['categories' => $categories], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div class="landing-shell">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredPost): ?>
                        <article class="blog-featured">
                            ...
                            ]); ?>" href="<?php echo e($featuredPost->getUrl()); ?>" aria-label="<?php echo e($featuredPost->title); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredPost->coverImageUrl()): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.landing.responsive-image','data' => ['path' => $featuredPost->cover_image_path,'alt' => $featuredPost->cover_image_alt ?: $featuredPost->title,'width' => '1200','height' => '800','loading' => 'eager','fetchpriority' => 'high','sizes' => '(max-width: 1024px) calc(100vw - 32px), 520px','class' => 'blog-featured__image','pictureClass' => 'blog-featured__picture']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['path' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($featuredPost->cover_image_path),'alt' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($featuredPost->cover_image_alt ?: $featuredPost->title),'width' => '1200','height' => '800','loading' => 'eager','fetchpriority' => 'high','sizes' => '(max-width: 1024px) calc(100vw - 32px), 520px','class' => 'blog-featured__image','picture-class' => 'blog-featured__picture']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredPost->shouldShowArticleLogo()): ?>
                                        <img
                            ...
                            <div class="blog-featured__body">
                                <div class="blog-card__meta">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredPost->displayCategory()): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredPost->categoryUrl()): ?>
                                            <a class="blog-card__category" href="<?php echo e($featuredPost->categoryUrl()); ?>"><?php echo e($featuredPost->displayCategory()); ?></a>
                                        <?php else: ?>
                                            <span><?php echo e($featuredPost->displayCategory()); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredPost->publishedDate()): ?>
                                        <time datetime="<?php echo e($featuredPost->publishedDate()->toDateString()); ?>"><?php echo e($featuredPost->publishedDate()->format('d.m.Y')); ?></time>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredPost->reading_time_minutes): ?>
                                        <span><?php echo e($featuredPost->reading_time_minutes); ?> мин</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <h2><a href="<?php echo e($featuredPost->getUrl()); ?>"><?php echo e($featuredPost->title); ?></a></h2>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredExcerpt = $featuredPost->previewExcerpt(150)): ?>
                                    <p><?php echo e($featuredExcerpt); ?></p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <a class="btn btn--primary" href="<?php echo e($featuredPost->getUrl()); ?>">
                                    Читать статью
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.landing.icon','data' => ['name' => 'arrow-right']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($posts->hasPages()): ?>
                            <div class="blog-pagination">
                                <?php echo e($posts->onEachSide(1)->links('blog._pagination')); ?>
...
<?php /**PATH C:\laragon\www\24logistru\resources\views/blog/index.blade.php ENDPATH**/ ?>